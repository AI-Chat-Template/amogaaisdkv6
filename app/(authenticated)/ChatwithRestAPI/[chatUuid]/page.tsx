...
import ChatHeader from "@/app/(authenticated)/ChatwithRestAPI/_components/chat-header";
import ChatBody from "@/app/(authenticated)/ChatwithRestAPI/_components/chat-body";
import ChatInput from "@/app/(authenticated)/ChatwithRestAPI/_components/chat-input";
    ...
    const fetchChat = async () => {
      try {
        ...
        const res = await fetch(
          `/api/ChatwithRestAPI/loadchat?chatUuid=${chatUuid}`,
          { method: "GET" }
        );
