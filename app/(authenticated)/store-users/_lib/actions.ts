...
export async function createRecord(
  ...
  try {
    ...
    // Runtime validation (excluding file which is handled separately)
    const { file, ...inputWithoutFile } = input;
    const validated = createContactSchema.safeParse(inputWithoutFile);
